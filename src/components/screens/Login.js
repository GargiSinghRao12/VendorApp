...
class Login extends React.Component {
    ...
    //     try {
    //         console.log('hello kuldeep', data)
    ...
    render() {
        return (
            <SafeAreaView style={styles.container}>
                ...
                <View style={{ flex: 0.25, justifyContent: 'center', alignItems: 'center', backgroundColor: globalStyle.thirdThemeColor }}>

                </View>
                <View style={{ flex: 0.5, justifyContent: 'center', alignItems: 'center', backgroundColor: globalStyle.primaryThemeColor }}>
                    <View style={{ height: wp("10%"), width: wp("85%"), justifyContent: 'center' }}>
